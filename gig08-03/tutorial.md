...
![](https://raw.githubusercontent.com/google-cloud-japan/gig-training-materials/main/gig07-03/img/diagram.png)
...
1. ディレクトリを移動する
    ...
    ```sh
    cd ~/cloudshell_open/gig-training-materials/gig07-03
    ```
...
gcloud builds triggers create cloud-source-repositories \
    ...
    --repo="cicd-sample" \
    --branch-pattern="main" \
    --build-config="gig07-03/cloudbuild.yaml"
```
