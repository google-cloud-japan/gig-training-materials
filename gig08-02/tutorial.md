...
```bash
cd ~/cloudshell_open/gig-training-materials/gig08-02/
```
...
HTTP リクエストに応答する Node.js アプリケーションを準備します。アプリケーションは `gig08-02/helloworld` というディレクトリにあります。
...
[**index.mjs**](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig08-02/index.mjs)
