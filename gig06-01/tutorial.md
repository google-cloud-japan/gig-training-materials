...
```bash
cd ~/cloudshell_open/gig-training-materials/gig06-01/
```
...
![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/overview-img.png?raw=true)
...
**Output**
```terminal
Deploying container to Cloud Run service [metrics-writer] in project [gig6-1] region [asia-northeast1]
...
![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/visualizer_graph.png?raw=true)
...
![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/scale-out_img.png?raw=true)
...
```bash
cd ~/cloudshell_open/gig-training-materials/gig06-01/ && source vars.sh
```
...
![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/visualizer_graph_2.png?raw=true)
...
![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/hey_summary.png?raw=true)

8. クラウドコンソールの [Cloud Run セクション](https://console.cloud.google.com/run) にアクセスします。`metrics-writer` サービスをクリックし、`指標` タブを選択します。

![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/cloudrun_metrics_image.png?raw=true)
...
![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/concurrency_image.png?raw=true)
...
![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/visualizer_graph_3.png?raw=true)

4. `hey` 出力の要約を確認します。

![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/hey_summary_2.png?raw=true)
...
![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/nimble-traffic_image.png?raw=true)
...
![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/visualizer_graph_4.png?raw=true)
...
1. gig06-01 リポジトリディレクトリで、Terraform を初期化します。
```bash
terraform init
```
...
![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/security_image.png?raw=true)
...
![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/metrics-writer_logs.png?raw=true)
...
...
- members:
  - serviceAccount:metrics-writer-sa@gig6-1.iam.gserviceaccount.com
  role: roles/datastore.user
...
```
...
![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/aiml_image.png?raw=true)
...
3. Cloud Shell の右上の「エディタを開く」をクリックし、左のエクスプローラーから gig06-01 ディレクトリ内の更に aiml_cloudrun ディレクトリ内にある main.py を選択します。

![](https://github.com/google-cloud-japan/gig-training-materials/blob/main/gig06-01/image/source_code.png?raw=true)
...
**Output**
```terminal
Updated IAM policy for project [gig6-1].
bindings:
- members:
...
bindings:
- members:
  - projectEditor:gig6-1
  - projectOwner:gig6-1
  role: roles/storage.legacyBucketOwner
- members:
  - projectViewer:gig6-1
...
gcloud run deploy aiml-web-application \
  --allow-unauthenticated \
  --source ~/cloudshell_open/gig-training-materials/gig06-01/aiml_cloudrun
```
...
This command is equivalent to running `gcloud builds submit --tag [IMAGE] ~/cloudshell_open/gig-training-materials/gig06-01/aiml_cloudrun --image [IMAGE]`

Building using Dockerfile and deploying container to Cloud Run service [aiml-web-application] in project [gig6-1] region [asia-northeast1]
